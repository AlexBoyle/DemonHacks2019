...
app.get('/test', (req, res) => {
  ...
  postRequests({json:()=>{}}, 1, "Bagles", 123);
  postRequests({json:()=>{}}, 1, "Bagles", 123);
postRequests({json:()=>{}}, 1, "Yogurt", 15);
postRequests({json:()=>{}}, 1, "Pie", 4);
postRequests({json:()=>{}}, 1, "Mac n cheese", 10);
postRequests({json:()=>{}}, 1, "French onion soup", 8);
postRequests({json:()=>{}}, 1, "Coleslaw", 30);
postRequests({json:()=>{}}, 1, "Eggs", 60);
postRequests({json:()=>{}}, 1, "Gyros", 11);
postRequests({json:()=>{}}, 1, "Mashed potatoes", 4);
postRequests({json:()=>{}}, 1, "Chili", 9);

postDonation({json:()=>{}}, 1, "Hamburger", 12);
postDonation({json:()=>{}}, 1, "Fish", 6);
postDonation({json:()=>{}}, 1, "Fried rice", 8);
postDonation({json:()=>{}}, 1, "Pizza", 123);
postDonation({json:()=>{}}, 1, "Tikka masala", 3);
postDonation({json:()=>{}}, 1, "Mushroom", 43);
postDonation({json:()=>{}}, 1, "Hot dog", 20);
postDonation({json:()=>{}}, 1, "French fries", 66);
postDonation({json:()=>{}}, 1, "Watermelon", 20);
postDonation({json:()=>{}}, 1, "Turkey", 3);
